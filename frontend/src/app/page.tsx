  ...
  const testimonials = [
    {
      ...
      content: "Strategic AI Platform has revolutionized our intelligence operations. The quantum-enhanced insights are unparalleled in the industry.",
      rating: 5,
      avatar: "SC"
    },
    {
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="#capabilities" className="text-slate-300 dark:text-slate-300 text-slate-600 hover:text-white dark:hover:text-white hover:text-slate-900 transition-colors">
                Capabilities
              </Link>
