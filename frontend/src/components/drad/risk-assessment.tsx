...
import { Shield, AlertTriangle, Target, Activity, TrendingUp, CheckCircle, Clock, Zap } from 'lucide-react'

interface RiskFactor {
  id: string
  name: string
  category: 'regulatory' | 'compliance' | 'jurisdictional' | 'operational' | 'financial'
  probability: number
  impact: number
...
export function RiskAssessment() {
    ...
    const initialRisks: RiskFactor[] = [
      {
        ...
        trend: 'up',
        mitigation: 'Continuous monitoring and adaptive compliance framework'
      },
      {
        id: 'risk-002',
        ...
        trend: 'down',
        mitigation: 'Automated compliance checking and reporting system'
      },
      {
        id: 'risk-003',
        name: 'Cross-Border Legal Risk',
        ...
        trend: 'up',
        mitigation: 'Legal review and jurisdiction-specific risk assessment'
      },
      {
        id: 'risk-004',
        name: 'Operational Execution Risk',
        ...
        trend: 'stable',
        mitigation: 'Process automation and quality control systems'
      },
      {
        id: 'risk-005',
        ...
        lastAssessment: '1 day ago',
        trend: 'down',
        mitigation: 'Diversified portfolio and hedging strategies'
      }
    ]
  ...
  const getCategoryIcon = (category: string) => {
    switch (category) {
      ...
      case 'jurisdictional': return <Target className="h-4 w-4" />
  ...
  const getCategoryColor = (category: string) => {
    switch (category) {
      ...
      case 'compliance': return 'text-neon-green'
      case 'jurisdictional': return 'text-neon-purple'
      case 'operational': return 'text-neon-yellow'
      case 'financial': return 'text-neon-red'
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-muted-foreground">Comprehensive risk analysis for regulatory arbitrage activities</p>
          </div>
        ...
        <div className="space-y-3">
          {risks.map((risk, index) => (
            ...
            >
              ...
              <div className="mb-3">
                <div className="text-sm text-muted-foreground mb-2">{risk.mitigation}</div>
