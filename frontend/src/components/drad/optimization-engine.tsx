...
import { Zap, Target, TrendingUp, Activity, Brain, CheckCircle, Clock, Shield } from 'lucide-react'

interface OptimizationStrategy {
  id: string
  name: string
  type: 'performance' | 'cost' | 'risk' | 'compliance'
  improvement: number
...
export function OptimizationEngine() {
  ...
  useEffect(() => {
    const initialStrategies: OptimizationStrategy[] = [
      {
        id: 'opt-001',
        name: 'Regulatory Compliance Optimization',
        type: 'compliance',
        improvement: 45.2,
        implementation: 89.7,
        status: 'active',
      ...
      {
        id: 'opt-004',
        name: 'Performance Enhancement System',
        type: 'performance',
        improvement: 38.9,
        implementation: 82.4,
        status: 'analyzing',
  ...
  const getStrategyTypeColor = (type: string) => {
    switch (type) {
      case 'performance': return 'text-neon-red'
      case 'cost': return 'text-neon-green'
      case 'risk': return 'text-neon-yellow'
      case 'compliance': return 'text-neon-blue'
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            <h2 className="text-xl font-bold mb-2">Optimization Engine</h2>
            <p className="text-muted-foreground">Continuous optimization of regulatory arbitrage strategies and performance</p>
          </div>
          ...
          {strategies.map((strategy, index) => (
            ...
            >
              ...
              <div className="grid grid-cols-4 gap-3 mb-3">
                ...
                <div className="text-center">
                  <div className="text-sm font-bold text-neon-yellow">{strategy.efficiency.toFixed(1)}%</div>
