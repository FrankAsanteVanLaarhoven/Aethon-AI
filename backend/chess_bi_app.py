"""
Simplified Chess BI Application
Standalone FastAPI app for chess business intelligence
"""
...
app = FastAPI(
    title="Chess Business Intelligence API",
    description="Strategic decision making using chess-like minimax algorithms",
    version="1.0.0"
)
...
async def root():
    """Root endpoint"""
    return {
        "message": "Chess Business Intelligence API",
        "version": "1.0.0",
        "status": "operational",
        "features": [
            "Minimax algorithm for strategic decision making",
            "Chess-like business intelligence analysis",
            "Competitive landscape evaluation",
            "Strategic move recommendations"
        ],
        "endpoints": {
            "analyze": "/api/v1/chess-bi/analyze",
            "game_state": "/api/v1/chess-bi/game-state",
            "simulate_move": "/api/v1/chess-bi/simulate-move",
            "strategic_insights": "/api/v1/chess-bi/strategic-insights"
        }
    }
...
async def health_check():
    ...
    return {
        ...
        "services": {
            "chess_bi_engine": "operational",
            "minimax_algorithm": "operational"
        }
    }

@app.post("/api/v1/chess-bi/analyze", response_model=CompetitiveAnalysis)
...
@app.post("/api/v1/chess-bi/game-state", response_model=GameStateResponse)
...
@app.post("/api/v1/chess-bi/simulate-move")
...
@app.get("/api/v1/chess-bi/strategic-insights")
